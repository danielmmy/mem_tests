...
memtests: $(BIN)rand_generator_fastest $(BIN)rand_read_test $(BIN)rand_read_test_simple $(BIN)rand_read_test_register_offset_shift $(BIN)rand_read_test_register_offset_multiply $(BIN)rand_read_test_register_offset_lsl_scaled
